...
| Area          | Decision                                                                                                                                                 | Why                                                                                                                              |
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| **Executor**  | Split into 10 files: `executor.c`, `executor_utils.c`, `executor_cmd_utils.c`, `executor_external.c`, `executor_child.c`, `executor_child_exec.c`, `executor_child_format.c`, `executor_pipeline.c`, `executor_pipeline_steps.c`, `executor_count.c`. | Clear separation: entry point, redirections, shared helpers (restore_fds/execute_builtin/set_underscore), PATH resolution, child cleanup, child exec+error, error formatting, pipeline orchestration, pipeline fork steps, wait/count. All under src/executor/. |
